...
function LandingPageHeader() {
  ...
  return (
    <header className="select-none fixed top-0 left-0 right-0 z-50 bg-white backdrop-blur-md border-b border-gray-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-8">
            <div>
              ...
              <p className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-600 max-w-lg lg:leading-10.5">
                O maior banco de
              </p>
              <p className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-600 max-w-lg lg:leading-10.5" >dados de arquitetura</p>
              <p className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-600 max-w-lg lg:leading-10.5">do país</p>
