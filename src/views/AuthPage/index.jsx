  ...
  return (
    <div className='overflow-x-hidden h-[100vh]'>
      <div className="verification-container">
        ...
        {!limitReached ? (
          <div className="flex flex-col justify-between min-h-screen md:grid md:grid-cols-2 md:py-4 md:min-w-[1080px]">
            {/* lado esquerdo */}
            <div className="flex flex-col justify-between min-h-[100vh] md:min-h-[calc(100vh-32px)]">
              <div className="space-y-8 md:space-y-10">
                <div className='w-full flex justify-center md:justify-start md:ml-29 md:mt-3'>
                  <SimpleHeader />
                </div>
                ...
                <div className='hidden md:block text-5xl w-[480px] md:ml-29'>
                  <h3>Verifique seu email</h3>
                </div>

                <div className="w-[360px] text-2xl ml-7 md:ml-29 md:text-4xl md:font-light md:w-[480px]">
                  <h1 className='font-Montserrat'>Digite o código de confirmação enviado em seu email</h1>
                </div>

                <div className="flex gap-4 ml-7 pt-4 md:ml-29 md:pt-0">
                ...
                <div className='w-[240px] md:w-[360px] ml-7 md:ml-29'>
          ...
          <div className="md:py-4 grid grid-cols-2 min-w-[874px]">
            <div className="w-90 font-Montserrat text-3xl text-center flex flex-col min-h-screen pt-6 md:pt-7 h-[100vh]">
              <div className="space-y-6 md:space-y-12 flex flex-col flex-grow"> {/* Adicionei flex-grow aqui */}
                <div className='w-full flex justify-center md:justify-start md:ml-29'>
                  <SimpleHeader />
                </div>
                ...
                <div className='mt-auto mb-8 flex justify-center md:justify-start md:ml-39'> {/* Adicionei mt-auto e mb-8 */}
                  <button
