...
">
            ...
            <div className="grid grid-row-2 shadow-[6px_6px_12px_rgba(0,0,0,0.45)] rounded-xl h-auto bg-[#F4F4F4] 
            md:mt-10 md:grid-cols-2 
">

                <div className="md:flex md:justify-center md:items-center  rounded-2xl">
                    <img src={Estatua} alt="estátua" className="rounded-xl w-full h-64 object-cover md:h-125 md:w-100" />
                </div>
