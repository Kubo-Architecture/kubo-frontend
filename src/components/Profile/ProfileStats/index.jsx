    ...
    return(
        <div className="h-[220px] min-w-[380px] w-full bg-white flex pt-[8px] px-[20px] md:px-[30px] lg:px-[40px] md:mt-[10px] lg:mt-[18px]">
            <div className="flex-grow h-full flex flex-col lg:flex-row">
                ...
                <p className="text-[18px] lg:text-[23px]"><strong className="text-[21px] lg:text-[25px]">{props.projetos}</strong> Projetos</p>
                <p className="text-[18px] lg:text-[23px]"><strong className="text-[21px] lg:text-[25px]">{props.likes}</strong> Likes</p>
                <p className="text-[18px] lg:text-[23px]"> <strong className="text-[21px] lg:text-[25px]">{props.seguidores}</strong> Seguidores</p>
                </div>
            </div>
