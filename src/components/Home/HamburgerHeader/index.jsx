  ...
  return (
    <>
      <div className="md:hidden">
        ...
        <div
          className={`fixed top-[7%] w-[185px] h-[59.2%] bg-[#f2f2f2] pt-[60px] transition-left duration-400 z-[1000] ${menuAberto ? "left-0" : "-left-[250px] "
            }`}
        >
          <ul className="list-none font-semibold">
            <li className="px-6 py-4 text-base cursor-pointer hover:bg-[#c4c4c4]">
