      ...
      <div className="w-full max-w-md bg-white rounded-2xl md:shadow-sm md:border md:border-gray-100 p-5 relative max-h-[95vh] overflow-y-auto">
        ...
        {showSuccessMessage && (
          <div className="mb-3 p-2.5 bg-green-50 border border-green-200 rounded-lg flex items-start gap-2">
            ...
            <div>
              <p className="text-xs font-semibold text-green-900">Login bem-sucedido!</p>
              <p className="text-[10px] text-green-700">Redirecionando...</p>
            </div>
          </div>
        )}
        ...
        {errors.general && (
          <div className="mb-3 p-2.5 bg-red-50 border border-red-200 rounded-lg flex items-start gap-2">
            ...
            <div>
              <p className="text-xs font-semibold text-red-900">login ou senha inválidos</p>
              <p className="text-[10px] text-red-700">{errors.general}</p>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-0">
          {/* Email */}
          <div>
            <h5 className="block text-black font-semibold mb-0.5 text-[10px] uppercase tracking-wider">
              Email
            </h5>
          ...
          <div>
            ...
            <div className="flex justify-end mb-1.5">
              <button
                ...
                className="text-[10px] text-blue-600 hover:text-blue-800 hover:underline transition font-semibold cursor-pointer"
              >
                Esqueceu a senha?
              </button>
            </div>
