    ...
    <section className="bg-white rounded-2xl overflow-hidden border border-neutral-200">
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="space-y-5 sm:space-y-6 mb-6 sm:mb-8">
          <div>
            ...
            <input
              ...
              className="w-full px-3 sm:px-4 py-3 sm:py-3.5 bg-white border border-neutral-200 rounded-xl text-sm font-medium text-black focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent hover:border-neutral-300 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <button className="w-full flex items-center justify-between px-3 sm:px-4 py-3 sm:py-3.5 bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 hover:border-neutral-300 rounded-xl text-sm font-semibold text-neutral-700 transition-all group">
        ...
        <div>
          ...
          <button className="flex items-center justify-center gap-2 px-3 sm:px-4 py-3 sm:py-3.5 bg-red-50 hover:bg-red-100 rounded-xl transition-all border border-red-200 hover:border-red-300 text-sm font-semibold text-red-700 w-full">
